...
const dupeFilters: FilterDefinition[] = [
  {
    keywords: 'dupe',
    hint: 'duplicate of another item',
    description: 'asgtykylilrthil',
    format: 'attribute',
    destinyVersion: 0,
  ...
  {
    keywords: 'dupelower',
    hint: 'worse duplicate of another item',
    description: 'asgtykylilrthil',
    format: 'attribute',
    destinyVersion: 0,
    contextGenerator: initDupes,
  ...
  {
    keywords: 'count',
    hint: 'number of dupes',
    description: 'filter by the number of dupes you have of an item',
    format: 'range',
    destinyVersion: 0,
    contextGenerator: initDupes,
